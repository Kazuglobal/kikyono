...
export class AppComponent implements AfterViewInit, OnDestroy {
  ...
  readonly calendarLeadingBlanks = signal<number[]>([0, 1, 2, 3, 4, 5]);

  readonly calendarDays = signal<CalendarDay[]>([
    { day: '1', type: 'event', label: '歓迎会&決起会(PM)', time: '9:00〜12:00', location: '桔梗野生活館' },
    { day: '2', type: 'game', label: '練習試合', location: '@いちょう公園', note: 'vs MTD' },
    { day: '3', type: 'rest', label: '休' },
    { day: '4', type: 'practice', time: '16:00〜18:30' },
    ...
    { day: '15', type: 'rest', label: '休', note: '新人戦予備日' },
    { day: '16', type: 'game', label: 'チャレンジ', note: 'vs MTD' },
    { day: '17', type: 'rest', label: '休' },
    { day: '18', type: 'practice', time: '16:00〜18:00' },
    { day: '19', type: 'rest', label: '休' },
    { day: '20', type: 'practice', time: '16:00〜18:00' },
    { day: '21', type: 'practice', time: '16:00〜18:00' },
    { day: '22', type: 'practice', time: '9:00〜12:00' },
    { day: '23', type: 'practice', time: '9:00〜12:00' },
    { day: '24', type: 'rest', label: '休' },
    { day: '25', type: 'practice', time: '16:00〜18:00' },
    { day: '26', type: 'rest', label: '休' },
    { day: '27', type: 'practice', time: '16:00〜18:00' },
    { day: '28', type: 'practice', time: '16:00〜18:00' },
    { day: '29', type: 'game', label: '市川地区親善大会', note: '会場・対戦相手未定' },
    { day: '30', type: 'practice', time: '9:00〜12:00' },
    { day: '31', type: 'rest', label: '休' },
  ]);
