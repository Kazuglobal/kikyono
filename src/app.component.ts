...
export class AppComponent implements AfterViewInit, OnDestroy {
  ...
  readonly calendarLeadingBlanks = signal<number[]>([0, 1]);

  readonly calendarDays = signal<CalendarDay[]>([
    { day: '1', type: 'practice', time: '16:00〜18:30', note: '久保田' },
    { day: '2', type: 'rest', label: '休' },
    { day: '3', type: 'practice', time: '16:00〜18:30', note: '中村(信)' },
    { day: '4', type: 'practice', time: '16:00〜18:30', note: '河原木' },
    { day: '5', type: 'game', label: '北地区新人戦', location: '@多賀台野球場', note: 'vs 西ヤンチャーズ' },
    { day: '6', type: 'game', label: '北地区新人戦', location: '@多賀台野球場', note: '対戦相手未定' },
    { day: '7', type: 'rest', label: '休' },
    { day: '8', type: 'practice', time: '16:00〜18:30', note: '久保田' },
    { day: '9', type: 'rest', label: '休' },
    { day: '10', type: 'practice', time: '16:00〜18:30', note: '河原木' },
    { day: '11', type: 'practice', time: '16:00〜18:30', note: '板橋' },
    { day: '12', type: 'game', label: 'ナガセケンコー杯', location: '@五戸ひばり球場', note: 'vs 長者BBC' },
    { day: '13', type: 'game', label: 'ナガセケンコー杯', note: '会場・対戦相手未定' },
    { day: '14', type: 'rest', label: '休' },
    { day: '15', type: 'practice', time: '16:00〜18:00', note: '柳谷' },
    { day: '16', type: 'rest', label: '休' },
    { day: '17', type: 'practice', time: '16:00〜18:00', note: '山崎' },
    { day: '18', type: 'rest', label: '休', note: '参観日' },
    { day: '19', type: 'practice', time: '9:00〜12:00', note: '濱谷' },
    { day: '20', type: 'game', label: 'チャレンジカップ', location: '@南郷球場', note: 'vs MTD・AR' },
    { day: '21', type: 'rest', label: '休' },
    { day: '22', type: 'game', label: 'ナガセケンコー杯', note: '会場・対戦相手未定' },
    { day: '23', type: 'event', label: 'ナガセケンコー杯', note: '予備日' },
    { day: '24', type: 'practice', time: '16:00〜18:00', note: '河原木' },
    { day: '25', type: 'practice', time: '16:00〜18:00', note: '板橋' },
    { day: '26', type: 'practice', time: '9:00〜12:00', note: '中村(直)' },
    { day: '27', type: 'event', label: '地区運動会' },
    { day: '28', type: 'rest', label: '休' },
    { day: '29', type: 'practice', time: '16:00〜18:00', note: '久保田' },
    { day: '30', type: 'rest', label: '休' },
  ]);
